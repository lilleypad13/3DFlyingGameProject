...
public class ExampleClass : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.DrawLine(transform.position, Vector3.up * 10.0f, Color.green);
        Debug.DrawLine(transform.position, Vector3.forward * 10.0f, Color.blue);
        Debug.DrawLine(transform.position, interpolatedPosition * 10.0f, Color.yellow);
    }
}